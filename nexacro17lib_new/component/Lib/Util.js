 ...
 * var bNull = this.gfn_isNull("aaa");	// false
 */
pForm.gfn_isNullRtn = function(sValue)
{
 ...
 * // this = Form
 * trace(this.gfn_getSequenceId(this, "Button")); // output : Button1
 * trace(this.gfn_getSequenceId(this, "Button")); // output : Button2
 * // this = Form
 * trace(this.gfn_getSequenceId(this, "chk_")); // output : chk_1
 * trace(this.gfn_getSequenceId(this, "chk_")); // output : chk_2
*/		
pForm.gfn_getSequenceId2 = function(form, prefix)
{
	if ( this.gfn_isNull(form) ) 
	{
		trace("getSequenceId :: 1st argument doesn't exist !!");
...
/**
 * @class 현재일자의 주 데이터 구함 <br>
 * @param {String} GetDay - getDay()의 숫자형태 형태로 표현된 날짜.
 * @return {String} GetDay에 따른 일자 Return.
 */
pForm.gfn_getDayOfWeek = function(GetDay)
{
	...
	var resultDay = new Date(theYear, theMonth, theDate + (GetDay - theDayOfWeek));
