 ...
 * @return N/A
 */
pForm.gfn_openForm = function(objDs, nRow, arrArg, soNo, tabIndex)
{
	var objApp   = pForm.gfn_getApplication();	
    var sMenuId = objDs.getColumn(nRow, "MENU_ID");
    var sMenuNm = objDs.getColumn(nRow, "MENU_NAME");
    var sUrl    = objDs.getColumn(nRow, "PRGM_FULL_PATH");
	
	this.objApp.gds_so_no.setColumn(0,"SO_NO",soNo);
	this.objApp.gds_so_no.setColumn(0,"TAB_INDEX",tabIndex);
 ...
 * @return N/A
 */
pForm.gfn_openForm2 = function(objDs, programId, arrArg, soNo, tabIndex)
{
	var nRow = objDs.findRow("PRGM_ID",programId);
	var objApp   = pForm.gfn_getApplication();	
    var sMenuId = objDs.getColumn(nRow, "MENU_ID");
    var sMenuNm = objDs.getColumn(nRow, "MENU_NAME");
    var sUrl    = objDs.getColumn(nRow, "PRGM_FULL_PATH");
