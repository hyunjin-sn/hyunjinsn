if (nexacro.Environment)
{
    ...
    env.loadTypeDefinition = function ()
    {
        ...
        nexacro._addService("INTRV_M", "form", "./INTRV_M/", "session", null, "", "0", "0");
        nexacro._addService("Master_M", "form", "./Master_M/", "session", null, "", "0", "0");
        nexacro._addService("Client_M", "form", "./Client_M/", "session", null, "", "0", "0");
        nexacro._addService("ABC_M", "form", "./ABC_M/", "session", null, "", "0", "0");
        nexacro._addService("Cost_M", "form", "./Cost_M/", "session", null, "", "0", "0");
        nexacro._addService("DOC_POP", "form", "./DOC_POP/", "session", null, "", "0", "0");
        nexacro._addService("svc_dev", "JSP", "http://211.106.159.87:8080/", "none", null, "", "0", "0");
        nexacro._addService("dsLayout", "bs", "http://211.106.159.87:8080/", "none", null, "", "0", "0");
        nexacro._addService("svc_prod", "JSP", "http://211.106.159.87:8080/", "none", null, "", "0", "0");
        nexacro._addService("svc_file", "JSP", "http://211.106.159.87:8080/PMS/API/", "session", null, "", "0", "0");
        nexacro._addService("Panel_M", "form", "./Panel_M/", "session", null, "", "0", "0");
        ...
        nexacro._addService("ERP_M", "form", "./ERP_M/", "session", null, "", "0", "0");
        nexacro._addService("JSP", "file", "http://211.106.159.87:8080/PMS/jsp/", "none", null, "", "0", "0");
